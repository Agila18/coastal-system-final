        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    {/* Left Column - Map & Overall Risk Score */}
                    <div className="space-y-6">
                        ...
                        {showMap && (
                            <div className="bg-white rounded-xl shadow-lg p-6 min-h-[500px] flex flex-col">
                                ...
                                <div className="flex-1">
                                    <MapComponent
                                        latitude={riskData.village.latitude || 13.0500}
                                        longitude={riskData.village.longitude || 80.2800}
                        ...
                        <motion.div
                            ...
                            className={`${riskColors.bg} border-2 ${riskColors.border} rounded-xl shadow-lg p-8 flex-1 flex flex-col justify-center`}
                        >
                    ...
                    {/* Right Column - Individual Breakdown, Environmental & Settlement Data */}
                    <div className="space-y-6">
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-xl shadow-lg p-6 min-h-[500px] flex flex-col"
                        >
                        ...
                        {/* Environmental & Settlement Data Container */}
